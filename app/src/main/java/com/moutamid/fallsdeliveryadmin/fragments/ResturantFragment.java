...
import com.moutamid.fallsdeliveryadmin.databinding.FragmentResturantBinding;
...
public class ResturantFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding = FragmentResturantBinding.inflate(getLayoutInflater(), container, false);
        ...
        Constants.databaseReference().child(Constants.RESTAURANT_CATEGORY).addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void showDialog() {
        ...
        complete.setOnClickListener(v -> {
            ...
            if (!topicName.isEmpty()) {
                dialog.dismiss();
                CategoryModel model = new CategoryModel(UUID.randomUUID().toString(), topicName, Constants.RESTAURANT_CATEGORY);
                Constants.databaseReference().child(Constants.RESTAURANT_CATEGORY).child(model.uid).setValue(model)
